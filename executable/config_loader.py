...
def load_config_from_env() -> dict:
    ...
    config = {
        ...
        "offer_filter": {
            ...
            "max_posts_per_day": int(os.getenv("OFFER_FILTER_MAX_POSTS_PER_DAY", "25")),
            "max_per_category_day": int(os.getenv("OFFER_FILTER_MAX_PER_CATEGORY_DAY", "6")),
            "min_score": int(os.getenv("OFFER_FILTER_MIN_SCORE", "50")),
            "min_discount_pct": float(os.getenv("OFFER_FILTER_MIN_DISCOUNT_PCT", "20")),
            ...
            "min_interval_minutes": int(os.getenv("OFFER_FILTER_MIN_INTERVAL_MINUTES", "5")),
        },
    }
